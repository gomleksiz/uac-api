...
from .utils import prepare_payload, prepare_query_params, set_if_not_none
...
class Tasks:
    ...
    def task_launch_and_wait(self, payload=None, timeout=300, interval=10, **args):
        ...
        response = self.uc.task_instances.wait_for_status(
            id=task_instance_id, timeout=timeout, interval=interval
        )
        return response
